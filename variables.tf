...
variable "enable_ssh_firewall" { type = bool;   default = true }
variable "enable_http_firewall" { type = bool;  default = true }
variable "ssh_allowed_cidrs"   { type = list(string); default = ["35.235.240.0/20"] }
variable "nat_min_ports_per_vm" { type = number; default = 64 }
